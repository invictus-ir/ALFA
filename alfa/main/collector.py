...
class Collector:
    ...
    def query_one(self, logtype: str, user: str='all', max_results: int = 1000, max_pages: int = None, start_time: str = None, end_time: str = None, **kwargs) -> list:
        '''
        ...
        req = activities.list(userKey=user, applicationName=logtype,
                              maxResults=max_results, startTime=start_time, endTime=end_time)
        page_index = 0
    ...
    def query(self, logtype: str, user: str = 'all', max_results: int = 1000, max_pages: int = None, start_time: str = None, end_time: str = None, save=False, path=None, return_as_df=True, **kwargs) -> list:
        '''
    ...
    def save(self, data: dict, save_path: str, filename: str):
    ...
    def load_all(self, data_folder: str, as_activities_df: bool = True):
        ...
        only_json = filter(lambda x: os.path.isfile(x) and x.endswith('.json'), all_files)
        result = {'activities': {}}
        for f in only_json:
